...
const routes = [
  ...
  // ===============================================
  // 🎪 ДИНАМИЧЕСКИЙ МАРШРУТ ДЛЯ ВСЕХ МЕРОПРИЯТИЙ
  // Все мероприятия загружаются из БД через EventDetailPage
  // ===============================================

  {
    ...
    beforeEnter: (to, from, next) => {
      ...
      // admin обрабатывается отдельным маршрутом
      if (slug === 'admin') {
      ...
      console.log(`✅ Загрузка мероприятия: ${slug}`)
      next()
    }
  },
