<template>
  ...
  <div class="section">
    ...
    <div class="community-links">
      ...
      <a href="https://t.me/memesfromtaffy" class="community-card" target="_blank" rel="noopener">
        <div class="card-shine"></div>
        <div class="community-header">
          <div class="community-icon telegram">
            <i class="fab fa-telegram-plane"></i>
      ...
      <a href="https://discord.gg/nDkZRc54aD" class="community-card" target="_blank" rel="noopener">
        <div class="card-shine"></div>
        <div class="community-header">
          <div class="community-icon discord">
            <i class="fab fa-discord"></i>
          </div>
          <div class="community-name">Inferno femboys🔔</div>
        </div>
        <div class="community-description">
          Discord сервер для общения и совместных игр
        </div>
        <div class="community-members">
          <i class="fas fa-users"></i> 150+ подписчиков
        </div>
      </a>
    </div>
  </div>
