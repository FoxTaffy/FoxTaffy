...
export default {
  ...
  data() {
    return {
      ...
      eventName: 'Any furry fest V',
      eventSubtitle: 'Фурри-фестиваль, на котором мы соберем всех пушистых.',
      eventDescription: 'Фурри-фестиваль для всех пушистых с насыщенной программой: маркет художников, конкурс фурсьютов, фотозона, настольные и ролевые игры, VR, кинопоказы, мастер-классы, лекции и сценические активности.',
      eventDate: '19 октября 2024',
      eventTime: '12:00–19:00',
      eventLocation: 'Москва, Новосущёвский переулок, 6с1',
      eventAttendees: '140+',
      ...
      features: [
        {
          title: 'Фурсьют-дефиле',
          description: 'Более 100 участников в красочных костюмах на сцене',
          icon: 'fas fa-paw'
        },
        {
          title: 'Ярмарка художников',
          description: 'Большой маркет с художниками и крафтерами',
          icon: 'fas fa-paint-brush'
        },
        {
          title: 'Зона рисования',
          description: 'Графические планшеты, бумага, карандаши и фломастеры',
          icon: 'fas fa-pencil-alt'
        },
        {
          title: 'Игротека',
          description: 'Настолки от Мосигры, ролевые игры и VR',
          icon: 'fas fa-dice'
        },
        {
          title: 'Мастер-классы и лекции',
          description: 'Отдельный зал с обучающими сессиями',
          icon: 'fas fa-chalkboard-teacher'
        },
        {
          title: 'Конкурсы и викторины',
          description: 'Развлекательные активности и розыгрыши на сцене',
          icon: 'fas fa-star'
        }
      ],
      ...
      friends: [
        {
          ...
          description: 'Легенды',
          icon: 'fas fa-cat',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(39).jpg',
        }
      ],
      ...
      galleryImages: [
        ...
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(61).jpg', 
          alt: 'Открытие мероприятия' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(15).jpg', 
          alt: 'Главная сцена' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(6).jpg', 
          alt: 'Выступление ведущих' 
        },
        
        // Раздел 2: Фото с друзьями
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(29).jpg', 
          alt: 'С друзьями у входа' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(40).jpg', 
          alt: 'Групповое фото на фоне баннера' 
        },
        
        // Раздел 3: Арт-зона и маркет
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/AnyFurry%20Fest%20V%2FAFFV%20(43).jpg', 
