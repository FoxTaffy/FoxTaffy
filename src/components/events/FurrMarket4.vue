...
export default {
  ...
  data() {
    return {
      ...
      eventName: 'FurrMarket 4',
      eventSubtitle: 'Маркет на фурри-тематику',
      eventDescription: `FurMarket — это маркет на фурри-тематику! Здесь можно найти любимых авторов, крафтеров, пушистиков и много красивого, яркого мерча. Мероприятие, от которого можно пищать от восторга!`,
      eventDate: '2 августа',
      eventTime: 'с 12:00 - 18:00',
      ...
      {
        title: 'Фотозоны',
        description: 'Специальные зоны для фурсьютеров и гостей с профессиональными фотографами',
        icon: 'fas fa-camera'
      },
      {
        title: 'Коллекция своп-карт',
        description: 'Эксклюзивная коллекция обменных карточек от авторов и мастеров, доступная только на маркете',
        icon: 'fas fa-clone'
      },
      {
        title: 'Лотереи и розыгрыши',
        description: 'Участники выигрывают призы от художников и крафтеров в случайных розыгрышах',
        icon: 'fas fa-gift'
      }
      ],
      
      // Встреченные знакомые/новые друзья
      friendsTitle: 'Фотографии с друзьями:',
      friends: [
        {
          name: 'Volty',
          description: 'Рэальный дэбчик.',
          icon: 'fas fa-fox',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2017-02-22.JPG',
        }
      ],
      ...
      galleryImages: [
        ...
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/cQ_Z8EfwUEwLAnGr3mT2NsVdtIdTk-3Yphf6lhhyDUFpdEI6yo6f1-zNfVSHhzgbdVfmZRr49-UogbrFENWuC_vx.jpg', 
          alt: 'Открытие мероприятия' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-08-40.JPG', 
          alt: 'Главная сцена' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-08-21.JPG', 
          alt: 'Выступление ведущих' 
        },
        
        // Раздел 2: Фото с друзьями
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-08-14.JPG', 
          alt: 'С друзьями у входа' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-07-36.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-06-58.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2015-20-15.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2016-40-54.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-04%2021-26-18.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2016-58-19.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2017-02-22.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2017-02-30.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-02%2019-14-54.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/2025-08-05%2008-07-23.JPG', 
          alt: 'Групповое фото на фоне баннера' 
        }
      ...
      purchases: [
        ...
        },
        {
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER.JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(7).JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(6).JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(5).JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(4).JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(3).JPG',
          price: '500₽'
        },
        {
          title: 'Стикер-пак',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(1).JPG',
          price: '500₽'
        },
        {
          title: 'Брелок',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/BRELOK%20(1).JPG',
          price: '500₽'
        },
        {
          title: 'Брелок',
          author: 'BadgeMaker',
          authorIcon: 'fas fa-id-card',
          description: 'Выйграйл в лотерее за 200 рублей хотя он стоит 850, я доволен',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/BRELOK%20(2).JPG',
          price: '200₽'
        },
        {
          title: 'Зночок',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/PIN%20(1).JPG',
          price: '0₽'
        },
        {
          title: 'Зночок',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/PIN%20(2).JPG',
          price: '100₽'
        },
        {
          title: 'Зночок',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/PIN%20(3).JPG',
          price: '100₽'
        },
        {
          title: 'Наклейка',
          ...
          authorIcon: 'fas fa-id-card',
          description: 'Ламинированный пропуск с красивым дизайном и удобным креплением.',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/STIKER%20(2).JPG',
          price: '0₽'
        },
        {
          ...
          authorIcon: 'fas fa-paint-brush',
          description: 'Красивый металлический значок с изображением моей фурсоны. Отличное качество и детализация!',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/NABOR.JPG',
          price: '0₽'
        },
        {
          title: 'Игрушка',
          ...
          authorIcon: 'fas fa-paint-brush',
          description: 'Красивый металлический значок с изображением моей фурсоны. Отличное качество и детализация!',
          image: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/FurrMarket4/PLAY.JPG',
          price: '0₽'
        },
      ...
      // Плюсы и минусы
      likes: [
        'Хорошо работающие кондиционеры',
