...
export default {
  ...
  data() {
    return {
      ...
      eventName: 'Тупикон',
      eventSubtitle: 'Стройка на тупиконе',
      eventDescription: '2PCON — это твой конвент, где ты сам выбираешь настроение: днём можешь зависнуть за настолками, пройти квест или влиться в соревнования, а вечером — оторваться на дискотеке или устроиться у костра с друзьями. Здесь всё сделано так, чтобы тебе было уютно, весело и по-настоящему своё.',
      eventDate: '4-7 сентября 2025',
      eventTime: 'Многодневный',
      eventLocation: 'Калужская область',
      eventAttendees: '300+',
      
      // Баннер мероприятия (главное изображение)
      eventBannerImage: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/fon.jpg',
      
      // Бейджик (VIP или Волонтёр)
      eventBadge: true,
      eventBadgeClass: 'standard',  // 'vip', 'volunteer', 'standard'
      eventBadgeText: 'Стандарт',
      ...
      // ===============================================================
      metaTitle: '2P Конвент - Мой опыт посещения | Fox Taffy',
      metaDescription: 'Мои впечатления от посещения 2P конвента "STROYKA NA TUPIKONE" - фотографии, покупки, знакомства и яркие моменты с этого замечательного мероприятия на базе Изумруд.',
      metaImage: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/fon.jpg',
      metaUrl: 'https://foxtaffy.fun/events/sillycon',
      
      // Официальные ссылки на соцсети мероприятия
      officialLinks: [
        {
          url: 'https://sillycon.ru',
      ...
      // Особенности мероприятия
      featuresTitle: 'Что было на конвенте:',
      features: [
        {
          title: 'Мастер-классы',
          description: 'Полезные воркшопы по рисованию и творчеству.',
          icon: 'fas fa-paint-brush'
        },
        {
          title: 'Квесты',
          description: 'Хоррор квесты в подвале.',
          icon: 'fas fa-tree'
        },
        {
          title: 'Фаершоу',
          description: 'Зрелищные выступления с огнём и драйвом.',
          icon: 'fas fa-fire'
        },
        {
          title: 'Денс батлы',
          description: 'Танцевальные соревнования с поддержкой публики.',
          icon: 'fas fa-music'
        },
        {
          title: 'Бар и кальян',
          description: 'Коктейли, уютные уголки и чилловая атмосфера.',
          icon: 'fas fa-cocktail'
        },
        {
          title: 'Посиделки у костра',
          description: 'Песни, шашлыки и душевные разговоры до утра.',
      ...
      friendsTitle: 'Мои новые знакомые на конвенте:',
      friends: [
        {
          name: 'Я лох',
          description: 'Мне было плохо, я мало с кем знакомился',
      ...
      galleryImages: [
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01645343796-1.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01780.jpg', 
          alt: 'Игры и развлечения' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01857-1.jpg', 
          alt: 'Посиделки у костра' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC0187652.jpg', 
          alt: 'Вечерняя дискотека' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01906-1.jpg', 
          alt: 'С друзьями на конвенте' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01912-1.jpg', 
          alt: 'С друзьями на конвенте' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01925-1.jpg', 
          alt: 'С друзьями на конвенте' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC054331778-1.jpg', 
          alt: 'Арт-маркет' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/DSC01645343796-1.jpg', 
        ...
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_10_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_2025-09-04_15-00-07.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_12_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_13_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_15_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_16_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_17_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_18_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_19_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_2_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_20_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_21_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_23_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_24_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_4_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_5_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_6_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_7_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_8_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_9_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        },
        { 
          src: 'https://plugjsubjcfblzkabjia.supabase.co/storage/v1/object/public/gallery/events/2P/photo_3_2025-09-10_23-13-37.jpg', 
          alt: 'С Felix' 
        }
      ...
      // ===============================================================
      impressionsIntro: 'Кон оставил кучу эмоций: для многих он стал ламповой тусовкой с друзьями и творчеством, но были и моменты, которые реально подбесили.',
      ...
      ratingCategories: [
        ...
        { name: 'Питание', rating: 3 }
      ],
      
      // Плюсы и минусы
      likes: [
        'Дружелюбная и ламповая атмосфера',
        'Разнообразная программа (мастер-классы, квесты, дискотеки)',
        'Мощные ивенты: денс батлы, фаершоу, концерты',
        'Вкусная столовка, особенно пончики',
        'Бар и коктейли на уровне',
        'Много фурсьютеров и фоток с ними',
        'Уютные посиделки у костра',
        'Классные художники и арты',
        'Орги и волонтёры старались по максимуму',
        'Каждый год кон становится ярче и круче'
      ],

      dislikes: [
        'Шум ночью в жилых корпусах',
        'Очереди в столовой 20–30 минут',
        'Общие туалеты и душевые',
        'Маленькие номера без удобств',
        'Кринж-пати с откровенной тематикой не всем зашла',
        'Еда местами средняя, как в лагере',
        'Локация неудобная и не всегда комфортная',
        'Организация некоторых ивентов выглядела сыровато'
      ],
      ...
      highlightMoments: [
        {
          title: 'Фаершоу',
          description: 'Первое выступление с огнём, поддержка зала и дикая энергетика.',
          icon: 'fas fa-fire'
        },
        {
          title: 'Денс батл',
          description: 'Толпа орала, участники выкладывались, атмосфера накала.',
          icon: 'fas fa-music'
        },
        {
          title: 'Бар',
          description: 'Коктейли, кальян, уютная чилловая зона для отдыха.',
          icon: 'fas fa-cocktail'
        },
        {
          title: 'Открытие с мультфильмом',
          description: 'Анимация от любимых художников зашла на ура.',
          icon: 'fas fa-film'
        }
      ],
      ...
      conclusion: 'Для большинства Тупикон — это ламповая тусовка, море эмоций и творчества. Но для части людей — спорная организация, бытовые минусы и «кринжовые» ивенты. Опыт сильно зависит от ожиданий.',
      nextEventsTitle: 'Похожие мероприятия на которых я был:',
      nextEvents: [
        { path: '/events/foxwood', title: 'FoxWood 2000 (май 2025)' },
        { path: '/events/SkyFurrBurg', title: 'SkyFurrBurg (июль 2025)' }
      ],
