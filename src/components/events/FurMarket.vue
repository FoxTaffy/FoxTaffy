  ...
  data() {
    return {
      ...
      friends: [
        {
          name: 'Goodwin',
          description: 'Встретились впервые! Очень дружелюбный и милый лапа.',
          icon: 'fas fa-cat',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(16).jpg',
        },
        {
          name: 'Frosty',
          description: 'Давний знакомый, общительный барся.',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(29).jpg',
        },
        {
          name: 'Roy skrim',
          description: 'Приятный душевый человек с которым приятно проводить время.',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(11).jpg',
        },
        {
          name: 'Hosty',
          description: 'Булочка с корицей, смешняфка.',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(36).jpg',
        },
        {
          name: 'Акулов',
          description: 'Сухопутная акула, не бупать!',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/friends%2Ffriend21.jpg',
        },
        {
          name: 'Настя',
          description: 'Вернулись бы в 90е? Она уже там.',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/friends%2Ffriend17.jpg',
        },
        {
          name: 'Ghost',
          description: 'Давний знакомый, отличный собеседник и крафтер.',
          icon: 'fas fa-fox',
          image: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(21).jpg',
        },
      ],
      ...
      galleryImages: [
        ...
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(1).jpg', 
          alt: 'Открытие мероприятия' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(2).jpg', 
          alt: 'Главная сцена' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(3).jpg', 
          alt: 'Выступление ведущих' 
        },
        
        // Раздел 2: Фото с друзьями
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(4).jpg', 
          alt: 'С друзьями у входа' 
        },
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(5).jpg', 
          alt: 'Групповое фото на фоне баннера' 
        },
        
        // Раздел 3: Арт-зона и маркет
        { 
          src: 'https://5e9762b1-f4cb-456c-a5a1-ee0773e66d88.selstorage.ru/FurMarket5%2FFurMarket%20(6).jpg', 
